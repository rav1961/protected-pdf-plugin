...
class Protected_Pdf_Loader
{
	 ...
	 * @since 	1.0.0
	 * @access 	protected
	 * @var 	array 	$shortcodes		The shortcodes registered with WordPress to fire when the pligin loads.
	 */
	...
	/**
	 * Add a new shortcode to the collection to be registered with WrodPress
	 * 
	 * @since 	1.0.0
	 * @param    string               $hook             The name of the WordPress filter that is being registered.
	 * @param    object               $component        A reference to the instance of the object on which the filter is defined.
